...
// see https://github.com/microsoft/terraform-spring-boot
public class TerraformClient implements AutoCloseable {
  ...
  private static final String SUBS_ID_ENV_NAME = "ARM_SUBSCRIPTION_ID",
      ...
      SECRET_ENV_NAME = "ARM_CLIENT_SECRET",
      TENANT_ID_ENV_NAME = "ARM_TENANT_ID";
  ...
  private ProcessLauncher getTerraformLauncher(String command) throws IOException {
    ...
    launcher.setOrAppendEnvironmentVariable(
        USER_AGENT_ENV_NAME, USER_AGENT_ENV_VALUE, USER_AGENT_DELIMITER);
