...
@Tag("unit")
public class CreateStorageAccountVirtualNetworkLinkStepTest extends BaseStepTest {
  private CreateStorageAccountVirtualNetworkLinkStep testStep;
  ...
  void setup() {
    testStep =
        new CreateStorageAccountVirtualNetworkLinkStep(mockArmManagers, mockResourceNameProvider);
  }
  ...
  void doStepSuccess() throws InterruptedException {
    ...
    assertThat(
        mockFlightContext
            .getWorkingMap()
            .get(CreateStorageAccountVirtualNetworkLinkStep.STORAGE_VNET_LINK_ID, String.class),
  ...
  void undoStepSuccess() throws InterruptedException {
    ...
    workingMap.put(CreateStorageAccountVirtualNetworkLinkStep.STORAGE_VNET_LINK_ID, resourceId);
