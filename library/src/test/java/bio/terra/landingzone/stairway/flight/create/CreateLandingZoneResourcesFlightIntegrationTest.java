...
public class CreateLandingZoneResourcesFlightIntegrationTest extends BaseIntegrationTest {
  ...
  private void startResourceCreationFlight(String jobId, LandingZoneRequest request) {
    ...
    final LandingZoneJobBuilder jobBuilder =
        azureLandingZoneJobService
            ...
            .flightClass(TestCreateLandingZoneResourcesFlight.class)
            .landingZoneRequest(request)
            .operationType(OperationType.CREATE)
            .bearerToken(bearerToken)
            .addParameter(LandingZoneFlightMapKeys.LANDING_ZONE_CREATE_PARAMS, request)
  ...
  void createResourcesFlightDeploysProtectedDataResourcesAndDeleteIt() {
    ...
    startResourceCreationFlight(jobId.toString(), request);
    await()
