...
public class CreateVnetStep extends BaseResourceCreateStep {
  ...
  public StepResult doStep(FlightContext context) throws InterruptedException, RetryException {
    ...
    try {
      ...
      var vNetId = "vNetTestId";
      context
          .getWorkingMap()
          .put(
              VNET_RESOURCE_KEY,
              LandingZoneResource.builder().resourceId(vNetId /*vNet.id()*/).build());
  ...
  public StepResult undoStep(FlightContext context) throws InterruptedException {
    var vNetId =
        context.getWorkingMap().get(VNET_RESOURCE_KEY, LandingZoneResource.class).resourceId();
    try {
