package bio.terra.landingzone.stairway.common.utils;

import bio.terra.landingzone.stairway.common.exception.MDCHandlingException;
 ...
 */
@Component
public class LandingZoneMdcHook implements StairwayHook {
  private static final Logger logger = LoggerFactory.getLogger(LandingZoneMdcHook.class);
  ...
  @Autowired
  public LandingZoneMdcHook(ObjectMapper objectMapper) {
