...
public class LandingZoneStepsDefinitionProviderFactory {
  // TODO: make enum
  public static final String CROMWELL_BASE_DEFINITION_STEPS_PROVIDER_TYPE = "cromwell";
  public static final String PROTECTED_DATA_DEFINITION_STEPS_PROVIDER_NAME = "protectedData";
