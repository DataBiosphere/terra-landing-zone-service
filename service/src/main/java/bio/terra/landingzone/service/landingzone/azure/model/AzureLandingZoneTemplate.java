...
public class AzureLandingZoneTemplate {
  private final String definition;
  private final String name;
  private final String description;
  private final String version;

  public AzureLandingZoneTemplate(
  ...
  public boolean equals(Object o) {
    ...
    AzureLandingZoneTemplate template = (AzureLandingZoneTemplate) o;
  ...
  public static class Builder {
    ...
    public AzureLandingZoneTemplate build() {
      return new AzureLandingZoneTemplate(definition, name, description, version);
    }
  }
}
