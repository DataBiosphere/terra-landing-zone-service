...
"""Validates landingzone definition endpoint"""
class LandingZoneDefinitionsTests(SmokeTestCase):
    ...
    def test_definitions(self):
        ...
        '''
        filtered_cromwell_lz_def = filter(lambda x: x["definition"] == LandingZoneDefinitionsTests.CROMWELL_LZ_DEFINITION_NAME, lzs_definitions)
        self.assertTrue(len(list(filtered_cromwell_lz_def)) == 1, "unexpected response for CromwellBaseResourcesFactory definition")